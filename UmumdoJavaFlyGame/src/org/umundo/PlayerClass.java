		...
		public void receiveObject(Object object, Message msg) {
			if (object != null) {
				...
				if (chatMsg.getType() == ChatMsg.Type.JOINED) {
					PlayerClass.this.participants.put(msg.getMeta("subscriber"),
							chatMsg.getUsername());
				...
				else if(chatMsg.getType() == ChatMsg.Type.FLYCORD) {
					//fly coordinate message
					System.out.println(chatMsg.getFlyCordX() + ": "
							+ chatMsg.getFlyCordY());
...
//		System.load("/Users/sradomski/Documents/TK/Code/umundo/build/cli/lib/libumundoNativeJava64.jnilib");
		PlayerClass chat = new PlayerClass();
		chat.run();
	}
}
